...
<body>
    ...
    <div class="container crud-container">
        ...
        <?php endif; ?>
        <form method="POST" action="añadir_mesa.php" class="flex-form">
            <div class="mb-3">
                <label for="numero_mesa" class="form-label text-white">Número de Mesa</label>
                <input type="number" class="form-control custom-input" id="numero_mesa" name="numero_mesa" required>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control custom-input" id="numero_sillas" name="numero_sillas" required>
